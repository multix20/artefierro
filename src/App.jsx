          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                <a href="#inicio" className="hover:text-amber-400 transition-colors px-3 py-2">
                  Inicio
                </a>
                <a href="#galeria" className="hover:text-amber-400 transition-colors px-3 py-2">
                  Galería
                </a>
                <a href="#servicios" className="hover:text-amber-400 transition-colors px-3 py-2">
                  Servicios
                </a>
                <a href="#contacto" className="hover:text-amber-400 transition-colors px-3 py-2">
                  Contacto
                </a>
              </div>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-zinc-800 border-t border-amber-600/20">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#inicio" className="block px-3 py-2 hover:text-amber-400 transition-colors">
                Inicio
              </a>
              <a href="#galeria" className="block px-3 py-2 hover:text-amber-400 transition-colors">
                Galería
              </a>
              <a href="#servicios" className="block px-3 py-2 hover:text-amber-400 transition-colors">
                Servicios
              </a>
              <a href="#contacto" className="block px-3 py-2 hover:text-amber-400 transition-colors">
                Contacto
              </a>
            </div>
          </div>
      ...
      <section id="inicio" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg mb-8 text-zinc-300 max-w-2xl mx-auto">
            Transformamos el fierro en obras de arte funcional que perduran en el
            tiempo
          </p>
      ...
      <section id="sobre-nosotros" className="py-20 bg-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div
              className={`transition-all duration-1000 ${isVisible['sobre-nosotros'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}
            >
              ...
              <p className="text-lg mb-6 text-zinc-300 leading-relaxed">
                Desde hace más de una década, Artefierro ha sido sinónimo de
                excelencia en el arte del fierro. Cada pieza que creamos nace de
                la pasión por transformar metal en obras que combinan
                funcionalidad y belleza.
              </p>
              <p className="text-lg mb-6 text-zinc-300 leading-relaxed">
                Nuestro taller es un espacio donde la tradición artesanal se
                encuentra con la innovación contemporánea, creando piezas únicas
                que reflejan la personalidad de cada cliente y la maestría de
                nuestro oficio.
              </p>
            ...
            <div
              className={`transition-all duration-1000 delay-300 ${isVisible['sobre-nosotros'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}
            >
              <img
      ...
      <section id="contacto" className="py-20 bg-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div
              className={`transition-all duration-1000 ${isVisible['contacto'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}
            >
              <div className="space-y-6">
                ...
                >
                  <Mail className="mr-2 w-5 h-5" /> Enviar Consulta
                </button>
              </div>
            </div>

            <div
              className={`transition-all duration-1000 delay-300 ${isVisible['contacto'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}
            >
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <a
                    href="https://wa.me/56912345678?text=Hola,%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20sus%20trabajos%20en%20fierro"
                    target="_blank"
                  ...
                  >
                    <MessageCircle className="mr-2 w-5 h-5" /> Escríbenos por
                    WhatsApp
                  </a>
                </div>
